...
<div id="listaEventos" >
<ul>
<li class="evento"><i class="fa fa-newspaper-o"></i><a href="javascript:void(0)" onclick="toggle_visibility('popup-box1')"> Satanás afirma que Juega BePolitics <i class="fa fa-plus-circle"></i></a></li>
<li class="evento"><i class="fa fa-newspaper-o"></i><a href="javascript:void(0)" onclick="toggle_visibility('popup-box2')"> El cara a cara entre Scar y Mufasa será el 14 de diciembre en la Academia de la Televisión <i class="fa fa-plus-circle"></i></a></li>
<li class="evento"> <i class="fa fa-newspaper-o"></i><a href="javascript:void(0)" onclick="toggle_visibility('popup-box3')"> Mariano Rajoy y Pablo iglesias se abrazan ante las cámaras <i class="fa fa-plus-circle"></i></a></li>
</ul>
